...
You can download the compendium as a zip from from this URL: <https://github.com/Hayata-Inoue/ABC/archive/master.zip>

Or you can install this compendium as an R package, ABC, from GitHub with:
